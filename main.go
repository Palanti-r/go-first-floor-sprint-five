...
func (s Swimming) TrainingInfo() InfoMessage {
	...
	return InfoMessage{
		...
		Distance:     s.distance(),   // расстояние, которое преодолел пользователь
		Speed:        s.meanSpeed(),  // средняя скорость, с которой двигался пользователь
		Calories:     s.Calories(),
	}
}
